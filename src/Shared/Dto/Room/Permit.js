 ...
 */
// MODULE'S VARS
const NS = 'Porter_Cust_Shared_Dto_Room_Permit';

/**
 * @memberOf Porter_Cust_Shared_Dto_Room_Permit
 * @type {Object}
 */
const ATTR = {
 ...
 */
export default class Porter_Cust_Shared_Dto_Room_Permit {
    /**
    ...
    constructor(
        ...
        // INSTANCE METHODS
        /**
         * @param {Porter_Cust_Shared_Dto_Room_Permit.Dto} [data]
         * @return {Porter_Cust_Shared_Dto_Room_Permit.Dto}
         */
