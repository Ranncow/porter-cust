 ...
 */
export default class Porter_Cust_Front_App {
    /**
     ...
     * @param {Porter_Cust_Front_Ui_Layout_Main.vueCompTmpl} layoutMain
     * @param {Porter_Cust_Front_Ui_Main.vueCompTmpl} uiMain
     */
    constructor(
        {
            container,
            ...
            Porter_Cust_Front_Ui_Layout_Main$: layoutMain,
            Porter_Cust_Front_Ui_Main$: uiMain,
        }
    ) {
        // VARS
        ...
        this.init = async function (fnPrintout) {
            ...
            function initRouter(app, DEF, container) {
                ...
                router.addRoute({
                    ...
                    component: () => container.get('Porter_Cust_Front_Ui_Route_About$'),
                    meta: {[META_ANON]: true},
                });
                router.addRoute({
                    path: DEF.ROUTE_HOME,
                    component: () => container.get('Porter_Cust_Front_Ui_Route_Home$'),
                    meta: {[META_ANON]: true},
                });
                router.addRoute({
