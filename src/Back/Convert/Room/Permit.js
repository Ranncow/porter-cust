 ...
 */
export default class Porter_Cust_Back_Convert_Room_Permit {
    /**
     * @param {TeqFw_Core_Shared_Util_Cast} cast
     * @param {Porter_Cust_Shared_Dto_Room_Permit} shared
     * @param {Porter_Base_Back_Store_RDb_Schema_Room_Permit} rdbPermit
     */
    constructor(
        {
            TeqFw_Core_Shared_Util_Cast$: cast,
            Porter_Cust_Shared_Dto_Room_Permit$: shared,
         ...
         * @returns {Porter_Cust_Shared_Dto_Room_Permit.Dto}
         */
         ...
         * @memberof Porter_Cust_Back_Convert_Room_Permit
         */

        /**
         * @param {Porter_Cust_Shared_Dto_Room_Permit.Dto} permit
